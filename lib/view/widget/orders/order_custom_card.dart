    ...
    return InkWell(
      onTap: () {
        Get.toNamed(AppRoutes.ordersDetails, arguments: {
          ...
          'phoneNumber': controller.branchModelData.branchPhone1,
        });
      },
      child: Container(
        // height: 270,
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      MaterialButton(
                        onPressed: () =>
                            controller.changeOrderState(1, ordersModel),
                        color: Colors.green,
                        elevation: 10,
                      ...
                      MaterialButton(
                        onPressed: () =>
                            controller.changeOrderState(5, ordersModel),
                        color: Colors.red,
                        elevation: 10,
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(10)),
              ...
              Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      MaterialButton(
                        onPressed: () => controller.changeOrderState(
                            ordersModel.ordersType == 0 ? 2 : 3, ordersModel),
                        color: Colors.green,
                        elevation: 10,
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(10)),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      MaterialButton(
                        onPressed: () =>
                            controller.changeOrderState(3, ordersModel),
                        color: Colors.green,
                        elevation: 10,
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(10)),
