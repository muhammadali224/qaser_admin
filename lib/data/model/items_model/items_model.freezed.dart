...
mixin _$ItemsModel {
  ...
  String? get itemsDesc => throw _privateConstructorUsedError;
  @JsonKey(name: "items_desc_ar")
  ...
  @JsonKey(name: "item_attr_id")
  int? get itemsAttrId => throw _privateConstructorUsedError;
  @JsonKey(name: "weigh_ids")
  List<String>? get weighIds => throw _privateConstructorUsedError;
...
abstract class $ItemsModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: "item_attr_id") int? itemsAttrId,
...
class _$ItemsModelCopyWithImpl<$Res, $Val extends ItemsModel>
  ...
  $Res call({
    ...
    Object? itemsAttrId = freezed,
    Object? weighIds = freezed,
    ...
    return _then(_value.copyWith(
      ...
      itemsNameAr: freezed == itemsNameAr
          ...
          : itemsNameAr // ignore: cast_nullable_to_non_nullable
              as String?,
      itemsDesc: freezed == itemsDesc
          ? _value.itemsDesc
          : itemsDesc // ignore: cast_nullable_to_non_nullable
              as String?,
      itemsDescAr: freezed == itemsDescAr
          ? _value.itemsDescAr
          : itemsDescAr // ignore: cast_nullable_to_non_nullable
              as String?,
      ...
      itemsActive: freezed == itemsActive
          ...
          : itemsActive // ignore: cast_nullable_to_non_nullable
              as int?,
      itemsPrice: freezed == itemsPrice
          ? _value.itemsPrice
          : itemsPrice // ignore: cast_nullable_to_non_nullable
              as num?,
      itemsDiscount: freezed == itemsDiscount
      ...
      itemsData: freezed == itemsData
          ...
          : itemsData // ignore: cast_nullable_to_non_nullable
              as DateTime?,
      itemsCat: freezed == itemsCat
          ? _value.itemsCat
          : itemsCat // ignore: cast_nullable_to_non_nullable
              as int?,
      itemsAttrId: freezed == itemsAttrId
          ? _value.itemsAttrId
          : itemsAttrId // ignore: cast_nullable_to_non_nullable
              as int?,
      weighIds: freezed == weighIds
          ? _value.weighIds
          : weighIds // ignore: cast_nullable_to_non_nullable
              as List<String>?,
...
class _$ItemsModelImpl implements _ItemsModel {
  const _$ItemsModelImpl(
      ...
      @JsonKey(name: "item_attr_id") this.itemsAttrId,
      @JsonKey(name: "weigh_ids") final List<String>? weighIds,
  ...
  @override
  @JsonKey(name: "item_attr_id")
  final int? itemsAttrId;
  final List<String>? _weighIds;
  @override
  @JsonKey(name: "weigh_ids")
  List<String>? get weighIds {
    final value = _weighIds;
    if (value == null) return null;
    if (_weighIds is EqualUnmodifiableListView) return _weighIds;
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.itemsDesc, itemsDesc) ||
                other.itemsDesc == itemsDesc) &&
            (identical(other.itemsDescAr, itemsDescAr) ||
            ...
            (identical(other.itemsAttrId, itemsAttrId) ||
                other.itemsAttrId == itemsAttrId) &&
            const DeepCollectionEquality().equals(other._weighIds, _weighIds) &&
  ...
  int get hashCode => Object.hash(
      ...
      itemsCat,
      itemsAttrId,
      const DeepCollectionEquality().hash(_weighIds),
...
abstract class _ItemsModel implements ItemsModel {
  const factory _ItemsModel(
      ...
      @JsonKey(name: "item_attr_id") final int? itemsAttrId,
      @JsonKey(name: "weigh_ids") final List<String>? weighIds,
      @JsonKey(name: "branch_ids") final List<String>? branchIds,
      @JsonKey(name: "images") final List<String>? images}) = _$ItemsModelImpl;
  ...
  @override
  @JsonKey(name: "items_desc")
  String? get itemsDesc;
  @override
  @JsonKey(name: "items_desc_ar")
  String? get itemsDescAr;
  @override
  @JsonKey(name: "items_image")
